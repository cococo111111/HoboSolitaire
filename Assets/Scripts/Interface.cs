...
//	int right = 840;
	...
	void OnGUI() {
		...
		GUI.Label(new Rect(right,40,1000,20), "Symbol / Word (Max 4) = x" + ScoreKeeper.symWrdVal);
		GUI.Label(new Rect(right,58,1000,20), "Sequence (Max 3) = x" + ScoreKeeper.seqVal);
		GUI.Label(new Rect(right,76,1000,20), "Proximity (Max 2) = x" + ScoreKeeper.prxVal);
